...
export const icons = { SquarePen, Hash, Image, Eraser, Scissors, FileText, Sparkles };
export const assets = {
  logo,
  gradientBackground,
  user_group,
...
export const AiToolsData = [
  {
    ...
    Icon: SquarePen,
    bg: { from: "from-[#3588F2]", to: "to-[#0BB0D7]" },
  ...
  },
  {
    ...
    Icon: Hash,
    bg: { from: "from-[#B153EA]", to: "to-[#E549A3]" },
    path: "/ai/blog-titles",
  },
  {
    ...
    Icon: Image,
    bg: { from: "from-[#20C363]", to: "to-[#11B97E]" },
  ...
  },
  {
    ...
    Icon: Eraser,
    bg: { from: "from-[#F76C1C]", to: "to-[#F04A3C]" },
  ...
  },
  {
    ...
    Icon: Scissors,
    bg: { from: "from-[#5C6AF1]", to: "to-[#427DF5]" },
  ...
  },
  {
    ...
    Icon: FileText,
    bg: { from: "from-[#12B7AC]", to: "to-[#08B6CE]" },
